...
- Making use of [next-image](https://nextjs.org/docs/api-reference/next/image) for images that appear on the index page as well as the hero image on the actual blog post page.
...
**NOTE:** Do not remove the _Plagiarism declaration_.
